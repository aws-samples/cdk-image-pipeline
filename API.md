...
| <code><a href="#cdk-image-pipeline.ImagePipeline.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="cdk-image-pipeline.ImagePipeline.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="cdk-image-pipeline.ImagePipeline.with.parameter.mixins"></a>
